...
var url = 'http://ec2-13-209-16-71.ap-northeast-2.compute.amazonaws.com:3000/messages';
var friendList = [];
var app = {
    server: 'http://ec2-13-209-16-71.ap-northeast-2.compute.amazonaws.com:3000/messages',
    init : function(){
    ...
    send : function(message){
        $.ajax({
            ...
            data: JSON.stringify({
            username: message.username || inputUsername,
